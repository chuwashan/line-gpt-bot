...
${d.name}さん、あなたの深層を見つめてみました。

🔹 あなたの真の性格
（生年月日と生まれ時間から読み取れる、変わることのない本質を2-3文で。具体的なエピソードを交えて）

🔹 宿る星と運命の流れ  
（現在の運気の流れと、今年〜来年にかけての大きな流れを2-3文で。希望を持てる内容に）

🔹 天賦の才能
（名前の響きやMBTIも参考に、まだ開花していない可能性を2-3文で。具体的な分野を示唆）

🔹 気をつけるべきこと
（バランスを整えるためのアドバイスを2-3文で。否定的にならず改善案として）

🔹 あなただけの開運の鍵
（総合的に見て、この人が幸せになるための具体的な行動を2-3文で）
...
【カードが紡ぐあなたの物語】
ここに400-600文字で、相談内容「${concern}」に対する深い洞察を書いてください。
